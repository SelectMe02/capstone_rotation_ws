...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.exposure', 'default': '380', 'description': 'RGB camera manual exposure value'},
                           {'name': 'rgb_camera.gain', 'default': '60', 'description': 'RGB camera manual gain value'},
                           {'name': 'rgb_camera.enable_auto_white_balance', 'default': 'false', 'description': 'enable/disable auto white balance for color image'},
                           {'name': 'rgb_camera.white_balance', 'default': '5680', 'description': 'RGB camera manual white balance value'},
